...
from config import HOST,CASE_JSON_VM
...
def teset_create_case(session_with_cookie,current_time_str):
    ...
    if "_id" in CASE_JSON_VM:
        del CASE_JSON_VM["_id"]
    CASE_JSON_VM['TestName'] = CASE_JSON_VM['TestName'] + current_time_str
    CASE_JSON_VM['DisplayName'] = CASE_JSON_VM['TestName']
    res = post(session_with_cookie, url, CASE_JSON_VM)
